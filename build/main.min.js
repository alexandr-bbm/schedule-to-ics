...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerEs6 = __webpack_require__(17);
	
	var _routerEs62 = _interopRequireDefault(_routerEs6);
	
	var _makeIcs = __webpack_require__(19);
	
	var _makeIcs2 = _interopRequireDefault(_makeIcs);
	
	var _spinnerEs6 = __webpack_require__(23);
	...
	var App = (function () {
	    ...
	    _createClass(App, [{
	        ...
	        value: function init() {
	            ...
	            this.loadBtnSpinner = new _spinnerEs6.Spinner(this.$dwnlBtn);
	        ...
	        key: 'bindDownloadForm',
	        value: function bindDownloadForm() {
	            var _this = this;
	
	            $('.get-ics-form').on('submit.downloadRasp', function (event) {
	                event.preventDefault();
	                _this.loadBtnSpinner.start();
	                var form = (0, _helper.getFormValues)($(event.target));
	                (0, _routerEs62['default'])(form.university, form.url).then(function (classes) {
	                    if (0 === classes.length) {
	                        throw new Error();
	                    }
	                    var cal = (0, _makeIcs2['default'])(classes);
	
	                    _this.loadBtnSpinner.stop();
	                    var data = {
	        ...
	        key: 'bindDownloadBtnSpinner',
	        value: function bindDownloadBtnSpinner() {}
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _currentWeekNumber = __webpack_require__(16);
	
	var _currentWeekNumber2 = _interopRequireDefault(_currentWeekNumber);
	...
	var DATE = {
	    ...
	    isWeekOdd: function isWeekOdd(date) {
	        return (0, _currentWeekNumber2['default'])(date) % 2;
	    }
	};
	...
	function getFormValues($form) {
	    var fieldObjects = $form.serializeArray();
	    var valObj = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getTpuScheduleEs6 = __webpack_require__(18);
	
	var _getTpuScheduleEs62 = _interopRequireDefault(_getTpuScheduleEs6);
	
	function router(university, url) {
	    switch (university) {
	        case 'ТПУ':
	            return (0, _getTpuScheduleEs62['default'])(url);
	            break;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = getTpuSchedule;
	
	function getTpuSchedule(url) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(ics) {'use strict';
	
	Object.defineProperty(exports, '__esModule', {
	    value: true
	});
	exports['default'] = makeIcs;
	...
	*/
	...
	function makeIcs(classes) {
	    var classDuration = arguments.length <= 1 || arguments[1] === undefined ? 95 : arguments[1];
	    var isTwoWeeks = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];
	
	    var calendar = ics();
	    var nextMonday = _helper.DATE.getNextMonday(); // следующий понедельник
	    var startMonday = new Date(nextMonday);
	    var weekInterval;
	    isTwoWeeks ? weekInterval = 2 : 1;
	    if (isTwoWeeks && !_helper.DATE.isWeekOdd(nextMonday)) {
	        // todo не работает нихера
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! ics.js Sat Jun 11 2016 13:48:30 */
	!function (a) {
	    "use strict";
	...
	"undefined" != typeof module && module.exports ? module.exports.saveAs = saveAs : "undefined" != "function" && null !== __webpack_require__(21) && null !== __webpack_require__(22) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return saveAs
	}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	var ics = function () {
	    "use strict";
